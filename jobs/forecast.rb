...
SCHEDULER.every '10s', :first_in => 0 do |job|
  ...
  uri = URI.parse("http://api.worldweatheronline.com/free/v1/weather.ashx?key=#{world_weather_online_api_key}&q=#{zip_code}&format=json")
  ...
  send_event('forecast', { farenheit: "#{farenheit}&deg;F", summary: "#{description}", code: "#{code}"})
end
